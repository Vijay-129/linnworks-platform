...
{ 
    public class AnyConfig : LinnObject
	{
		...
		// Was ConfigRuleCollection (a wrapper object) - the real API sends a plain JSON
		// array here (confirmed by both inventory.json's schema and a live GetChannels
		// call crashing on the mismatch). Fixed 2026-08-13.
