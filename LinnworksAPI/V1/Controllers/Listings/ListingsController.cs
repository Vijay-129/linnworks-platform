...
namespace LinnworksAPI
{
    public class ListingsController : BaseController, IListingsController
    {
        ...
        /// <summary>
        /// Use this call to cancel eBay listing bulk creation operations. Not in the old SDK -
        /// written new against references/api/v1/Listings.md (Linnworks spec has no rate-limited
        /// description beyond this; confirm behaviour against a real account before relying on it).
        /// Permissions Required: GlobalPermissions.Settings.ListingConfigurators.GetListingConfiguratorsNode
        /// </summary>
        /// <param name="pkOperationId">Id of the bulk operation to cancel</param>
        public void CancelListingBulkOperation(Int32 pkOperationId)
		{
			GetResponse("Listings/CancelListingBulkOperation", "pkOperationId=" + pkOperationId + "");
		}
		...
		/// <summary>
        /// Use this call to create wireup to create templates in bulk. Not in the old SDK -
        /// written new against references/api/v1/Listings.md (Linnworks spec response shape is
        /// untyped ("object"); confirm the actual response against a real account before relying
        /// on it). Permissions Required: GlobalPermissions.Settings.ListingConfigurators.GetListingConfiguratorsNode
        /// </summary>
        /// <param name="parameters">Locations and per-channel configurator ids to bulk-create templates for</param>
        public object CreateTemplatesFromViewInBulk(CreateTemplatesInBulkParameters parameters)
		{
			var response = GetResponse("Listings/CreateTemplatesFromViewInBulk", "parameters=" + System.Net.WebUtility.UrlEncode(JsonFormatter.ConvertToJson(parameters)) + "");
            return JsonFormatter.ConvertFromJson<object>(response);
		}
		...
		/// <summary>
        /// Use this call to get eBay listing bulk creation operations. Not in the old SDK -
        /// written new against references/api/v1/Listings.md (Linnworks spec response shape is
        /// untyped ("object"); confirm the actual response against a real account before relying
        /// on it). Permissions Required: GlobalPermissions.Settings.ListingConfigurators.GetListingConfiguratorsNode
        /// </summary>
        public object GetEbayListingOperations(GetEbayListingOperationsRequest request)
		{
			var response = GetResponse("Listings/GetEbayListingOperations", "request=" + System.Net.WebUtility.UrlEncode(JsonFormatter.ConvertToJson(request)) + "", "GET");
            return JsonFormatter.ConvertFromJson<object>(response);
		}
