...
{ 
	...
	{
		void CancelListingBulkOperation(Int32 pkOperationId);
		...
		object CreateTemplatesFromViewInBulk(CreateTemplatesInBulkParameters parameters);
		...
		object GetEbayListingOperations(GetEbayListingOperationsRequest request);
